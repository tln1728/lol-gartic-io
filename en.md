...
<details>
    <summary>Starter items (6/14) 🟢</summary>
...
<details>
    <summary>Potions and Consumables (5/8) 🟢</summary>
...
<details>
    <summary>Basic items (2/15) 🟢</summary>
...
<details>
    <summary>Epic items (5/48) 🟢</summary>
...
<details open>
    <summary>Legendary items</summary>
    <details open>
        <summary>Bruiser (16) 🟡</summary>
        <ol type="1">
            <li>Black Cleaver</li>
            <li>Chempunk Chainsword</li>
            <li>Death's Dance</li>
            <li>Eclipse</li>
            <li>Experimental Hexplate</li>
            <li>Guardian Angel</li>
            <li>Hullbreaker</li>
            <li>Overlord's Bloodmail</li>
            <li>Ravenous Hydra</li>
    ...
    <!------------------------------------------>
    <details open>
        <summary>Tank (17) 🟡</summary>
        <ol type="1">
            <li>Winter's Approach</li>
            <li>Fimbulwinter</li>
            <li>Thornmail</li>
            <li>Frozen Heart</li>
            <li>Abyssal Mask</li>
            <li>Sunfire Aegis</li>
            <li>Spirit Visage</li>
            <li>Randuin's Omen</li>
            <li>Hollow Radiance</li>
            <li>Unending Despair</li>
            <li>Force of Nature</li>
            <li>Iceborn Gauntlet</li>
            <li>Kaenic Rookern</li>
            <li>Dead Man's Plate</li>
            <li>Heartsteel</li>
            <li>Jak'Sho The Protean</li>
            <li>Warmog's Armor</li>
            <!-- <li></li> -->
        </ol>
    </details>
    <!------------------------------------------>
    <details open>
        <summary>Mage (24) 🟡</summary>
        <ol type="1">
            <li>Mejai's Soulstealer</li>
            <li>Rod of Ages</li>
            <li>Hextech Rocketbelt</li>
            <li>Archangel's Staff</li>
            <li>Blackfire Torch</li>
            <li>Malignance</li>
            <li>Luden's Companion</li>
            <li>Horizon Focus</li>
            <li>Morellonomicon</li>
            <li>Stormsurge</li>
            <li>Zhonya's Hourglass</li>
            <li>Nashor's Tooth</li>
            <li>Lich Bane</li>
            <li>Liandry's Torment</li>
            <li>Bloodletter's Curse</li>
            <li>Banshee's Veil</li>
            <li>Void Staff</li>
            <li>Cryptbloom</li>
            <li>Cosmic Drive</li>
            <li>Riftmaker</li>
            <li>Rylai's Crystal Scepter</li>
            <li>Shadowflame</li>
    ...
    <details open>
        ...
        <ol type="1">
            ...
            <li>Manamune</li>
            <li>Muramana</li>
            <li>Maw of Malmortius</li>
            <li>Profane Hydra</li>
            <li>Serpent's Fang</li>
            <li>Serylda's Grudge</li>
            <li>The Collector</li>
            <li>Umbral Glaive</li>
            <li>Voltaic Cyclosword</li>
    ...
    <!------------------------------------------>
    <details open>
        <summary>ADC (17) 🟡</summary>
        <ol type="1">
            <li>Blade of the Ruined King</li>
            <li>Bloodthirster</li>
            <li>Essence Reaver</li>
            <li>Guinsoo's Rageblade</li>
            <li>Infinity Edge</li>
            <li>Immortal Shieldbow</li>
            <li>Kraken Slayer</li>
            <li>Lord Dominik's Regards</li>
            <li>Mercurial Scimitar</li>
            <li>Mortal Reminder</li>
            <li>Navori Flickerblade</li>
            <li>Phantom Dancer</li>
            <li>Rapid Firecannon</li>
            <li>Runaan's Hurricane</li>
            <li>Statikk Shiv</li>
            <li>Terminus</li>
            <li>Yun Tal Wildarrows</li>
            <!-- <li></li> -->
        </ol>
    </details>
    <!------------------------------------------>
    <details open>
        ...
        <ol type="1">
            ...
            <li>Moonstone Renewer</li>
            <li>Zeke's Convergence</li>
            <li>Locket of the Iron Solari</li>
            <li>Staff of Flowing Water</li>
            <li>Mikael's Blessing</li>
            <li>Redemption</li>
            <li>Knight's Vow</li>
            <li>Dawncore</li>
            <li>Dream Maker</li>
            <li>Zaz'Zak's Realmspike</li>
            <li>Bloodsong</li>
            <li>Celestial Opposition</li>
            <li>Solstice Sleigh</li>
            <li>Imperial Mandate</li>
            <!-- Bounty of Worlds -->
            <!-- Trailblazer -->
            <!-- Vigilant Wardstone -->
            <!-- <li></li> -->
